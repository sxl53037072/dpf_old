...
SELECT T.*,T.ROWID FROM GET_VALUE_SHOW_CFG T where t.get_value_cfg_id = 2015;
--搜索栏
SELECT T.*,T.ROWID FROM COMPONENT T;
SELECT T.*,T.ROWID FROM SQL_PARAM_CFG T where t.sql_id = 2015;
--工具栏
